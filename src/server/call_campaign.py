def emrr():
        ...
        LEFT JOIN --- Project Due date ---
                ...
                ON MR_Table.[Outreach ID] = OM.OutreachId 
        ...
        WHERE 
                ...
                AND MR_Table.[Sub Retrieval Method] <> 'EMR - Remote Queued'
                ...
                AND pt.ProjectTypeDescription <> 'Fallon Health'																						--#
